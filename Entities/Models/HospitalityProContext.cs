        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<HotelService>(entity =>
            {
                entity.HasKey(e => e.ServiceId)
                    .HasName("PK__HotelSer__C51BB0EAD41CF085");
            ...
            modelBuilder.Entity<Notification>(entity =>
            {
                ...
                entity.HasOne(d => d.Sender)
                    ...
                    .HasConstraintName("FK__Notificat__Sende__59FA5E80");
            });
            ...
            modelBuilder.Entity<Reservation>(entity =>
            {
                ...
                entity.HasOne(d => d.User)
                    ...
                    .HasConstraintName("FK__Reservati__UserI__46E78A0C");
            ...
            modelBuilder.Entity<RoomPhoto>(entity =>
            {
                entity.HasKey(e => e.PhotoId)
                    .HasName("PK__Room_Pho__21B7B58260E6A951");
                ...
                entity.HasOne(d => d.Room)
                    ...
                    .HasForeignKey(d => d.RoomId)
                    .HasConstraintName("FK__Room_Phot__RoomI__5535A963");
            });

            modelBuilder.Entity<User>(entity =>
            {
                entity.HasIndex(e => e.Email, "UQ__Users__A9D10534AFB81322")
                    .IsUnique();
            ...
            modelBuilder.Entity<UserRole>(entity =>
            {
                ...
                entity.HasOne(d => d.User)
                    ...
                    .HasForeignKey(d => d.UserId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__User_Role__UserI__5CD6CB2B");
            });
