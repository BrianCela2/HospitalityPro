...
public class RequestResponseLoggerMiddleware
{
    ...
    public RequestResponseLoggerMiddleware(RequestDelegate next, IConfiguration config,IMapper mapper,IUnitOfWork unitOfWork, IHttpContextAccessor httpContextAccessor)
    {
        _next = next;
